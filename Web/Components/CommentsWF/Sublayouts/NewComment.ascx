...
<div class="basic-grey">
    <div class="blog-container">
        ...
        <asp:Panel CssClass="write-commment-container" ID="commentsContainer" runat="server">
           ...
           <%-- <asp:Panel ID="recaptchaPanel" CssClass="g-recaptcha" runat="server" ClientIDMode="Static"></asp:Panel>--%>
            <div id="newComment" class="g-recaptcha"></div>
            <div class="clear"></div>
            <div class="submit-container">
                <label>
                    <span>&nbsp;</span>
                    <asp:Button ID="SubmitButton" CssClass="button" Text="Submit" OnClick="ValidateCaptchaKey" runat="server" />
                </label>
            </div>
        </asp:Panel>
    </div>
